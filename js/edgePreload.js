...
(function (compId) {
    ...
    function isSupported(a) {
        var d = testEle.style, b;
        for (i = 0; i < a.length; i++)if (b = a[i], void 0 !== d[b])return!0;
        return!1
    }
    ...
    var hasTransform = isSupported(["transformProperty", "WebkitTransform", "MozTransform", "OTransform", "msTransform"]), hasSVG = !!document.createElementNS && !!document.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGRect, hasRGBA = supportsRGBA(), hasJSON = window.JSON && window.JSON.parse && window.JSON.stringify, readyToPlay = !1;
    ...
    AdobeEdge.requestResources = AdobeEdge.requestResources || function (a, d) {
        ...
        var b, k = a.length, f = [], c;
        for (b = 0; b < k; b++) {
            c = a[b];
            if ("string" === typeof c)0 === c.indexOf("//") && 0 === window.location.href.indexOf("file://") && (c = "http:" + c), url = c, c = {load: url}; else if (c.load && 0 === c.load.indexOf("//") && 0 === window.location.href.indexOf("file://") && (c.load = "http:" + c.load), url = c.yep || c.load, c.callback) {
                var g = c.callback;
    ...
    var filesToLoad, dlContent, preContent, doDelayLoad, signaledLoading, loadingEvt, requiresSVG, htLookup = {}, aLoader, aEffectors, plSTF, ctrPlS, minPlW, maxPlW, plHeight, plWidth;
    ...
    function bindPSS(a, d) {
        if (!isWrapped(a)) {
            var b = function () {
                var b = isWrapped(a), f = b ? parent(parent(parent(a))) : parent(a), c = width(f), g = height(f), h = width(a), n = height(a), m = window.innerHeight, e = 1, l = a.style;
    ...
    function simpleContent(a, d, b) {
        var k = document.getElementsByTagName("body")[0], f = b || findNWC(k, compId), c, g, h;
        ...
        for (var n = 0; n < a.length; n++) {
            ...
            if (b.transform && b.transform[0]) {
                var m = b.transform[0][0], e = splitUnits(m);
                if (e && e.units && (m = e.num, "%" == e.units && b.rect[2])) {
                    var e = b.rect[2], l = splitUnits(b.rect[2]);
            ...
            f.appendChild(k);
            if (b.c)for (h = 0; h < b.c.length; h++)simpleContent(b.c[h], d, k)
        }
    }

    var fnCycle = function (a) {
        a ? fnCycle && setTimeout(fnCycle, 20) : a = {event: "loading", progress: 0};
    ...
    window.AdobeEdge.bootstrapCallback = function (a) {
        ...
        if (0 < aBootcompsLoaded.length)for (var d = 0; d < aBootcompsLoaded.length; d++)a(aBootcompsLoaded[d])
    };
    ...
    window.AdobeEdge.preloadComplete[compId] = function (a) {
        ...
        fnCycle = null;
        loadingEvt && loadingEvt({event: "done", progress: 1, reason: "complete"});
    ...
    function onDocLoaded(a) {
        ...
        fnCycle({event: "begin"});
        isCapable() ? (preContent && preContent.dom && preContent.dom.length && simpleContent(preContent.dom, "edgePreload" + compId), filesToLoad && !signaledLoading && (loadResources(filesToLoad), filesToLoad = void 0)) : dlContent && dlContent.dom && (loadingEvt && loadingEvt({event: "done", progress: 1, reason: "downlevel"}), simpleContent(dlContent.dom))
    };
    window.AdobeEdge = window.AdobeEdge || {};
    ...
    aLoader = [
        ...
        { load: "Aviasales_KeepTime_2014-03-13_001_edge.js"},
        { load: "Aviasales_KeepTime_2014-03-13_001_edgeActions.js"}
    ];
    ...
    var plSTF = "none", ctrPlS = "none", minPlW = "0", maxPlW = undefined, plWidth = "100%", plHeight = "100%";
